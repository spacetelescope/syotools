...
result = compute_observation("EAC5", instrument="UV_IFU.UV_IFU_Group1_IFS", sed="Flat (AB)", magnitude=25.0, snr=10, redshift=0, extinction=0, bandpass="galex,fuv", target="exptime", verbose=True)
# plt.plot(wave, result)
# plt.ylim(1e1,1e22)
# plt.yscale("log")
# plt.show()
print(result)
result = compute_observation("EAC5", instrument="UV_IFU.UV_IFU_Group3_IFS", sed="Flat (AB)", magnitude=25.0, exptime=1, redshift=0, extinction=0, bandpass="galex,fuv", target="snr", verbose=True)
print(result)
