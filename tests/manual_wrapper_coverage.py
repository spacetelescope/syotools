...
print(result)
result = compute_observation("EAC5", instrument="UV_MOS.FUV_MOS_MOS", sed="Flat (AB)", magnitude=25.0, exptime=1, redshift=0, extinction=0, bandpass="galex,fuv", target="snr", verbose=False)
print(result)
result = compute_observation("EAC5", instrument="UV_MOS.FUV_MOS_L_MOS", sed="Flat (AB)", magnitude=25.0, exptime=1, redshift=0, extinction=0, bandpass="galex,fuv", target="snr", verbose=False)
print(result)
