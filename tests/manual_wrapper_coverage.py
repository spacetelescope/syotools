...
camera_exptime("EAC5", "Flat (AB)", 30, 10, silent=True)

camera_snr("EAC5", "Flat (AB)", 30, 10, silent=True)

camera_magnitude("EAC5", "Flat (AB)", 30, 10, silent=True)

uvspec_exptime("EAC5", "G150M", "Flat (AB)", 30, 10, silent=True)

uvspec_snr("EAC5", "G150M", "Flat (AB)", 30, 10, silent=True)
